...
class ChatViewController: JSQMessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        if let imageData = UserDefaults.standard.object(forKey: "backgroundImage"){
            ...
            if (imageData as AnyObject).length != 0{
                ...
                backgroundImage = UIImage(named: "backgroundImage.jpg")!
            }
        }
    ...
    override func didPressSend(_ button: UIButton!, withMessageText text: String!, senderId: String!, senderDisplayName: String!, date: Date!) {
        ...
        let rootRef = Database.database().reference(fromURL: "https://cloudchatroom-3ee2d.firebaseio.com/").child("message").child(address).child(roomName)
    ...
    func getInfo(){
        ...
        let firebase = Database.database().reference(fromURL: "https://cloudchatroom-3ee2d.firebaseio.com/").child("message").child(address).child(roomName)
