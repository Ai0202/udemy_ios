...
class EditViewController: UIViewController, UITextViewDelegate {
    ...
    func postAll() {
        ...
        let rootRef = Database.database().reference(fromURL: "https://swiftmemory-4aa76.firebaseio.com/").child("address").child(self.address)
        //ここに1つつくる
        let rootRef2 = Database.database().reference(fromURL: "https://swiftmemory-4aa76.firebaseio.com/").child("AddressforPin")
        let storage = Storage.storage().reference(forURL: "gs://swiftmemory-4aa76.appspot.com")
